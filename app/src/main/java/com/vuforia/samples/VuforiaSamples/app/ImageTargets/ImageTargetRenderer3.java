...
public class ImageTargetRenderer3 implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    private static final String LOGTAG = "ImageTargetRenderer";

    private SampleApplicationSession vuforiaAppSession;
    private ImageTargets3 mActivity;
    ...
    public ImageTargetRenderer3(ImageTargets3 activity, SampleApplicationSession session)
    {
        mActivity = activity;
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
            ...
            if (!mActivity.isExtendedTrackingActive()) {
                Intent i = new Intent(mActivity, VideoPlay.class);
