...
public class ImageTargetRenderer2 implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    private static final String LOGTAG = "ImageTargetRenderer";

    private SampleApplicationSession vuforiaAppSession;
    private ImageTargets2 mActivity;
    ...
    public ImageTargetRenderer2(ImageTargets2 activity, SampleApplicationSession session)
    {
        mActivity = activity;
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
            ...
            if (!mActivity.isExtendedTrackingActive()) {
                //Intent i = new Intent(mActivity, Shine.class);
